...
if __name__ == '__main__':
    ...
    join = {'Accord-', 'Act-', 'Brief-', 'Follow-', 'Representa-', 'Sensi', 'accept-', 'accord-', 'achiev-', 'act-',
            ...
            'demonstrat-', 'develop-', 'direc-', 'dur-', 'effec-', 'emanat-', 'emerg-', 'encourag-', 'establish-',
            'even-', 'exclud-', 'execu-', 'exist-', 'expand-', 'express-', 'fight-', 'follow-', 'formulat-', 'forward-',
            'group-', 'grow-', 'hear-', 'help-', 'impera-', 'imprison-', 'improv-', 'includ-', 'increas-', 'ineffec-',
            'initia-', 'inject-', 'interest-', 'involv-', 'issu-', 'lead-', 'limit-', 'liv-', 'maintain-', 'mak-',
            'mean-', 'meet-', 'mobiliz-', 'morn-', 'mount-', 'nega-', 'negotiat-', 'objec-', 'open-', 'operat-',
            'organiz-', 'point-', 'posi-', 'prepar-', 'present-', 'prevail-', 'proceed-', 'promis-', 'propos-',
    ...
    joined = {'According', 'Acting', 'Briefing', 'Following', 'Representative', 'Sensitive', 'accepting', 'according',
              ...
              'developing', 'directive', 'during', 'effective', 'emanating', 'emerging', 'encouraging', 'establishing',
              'evening', 'excluding', 'executive', 'existing', 'expanding', 'expressing', 'fighting', 'following',
              'formulating', 'forwarding', 'grouping', 'growing', 'hearing', 'helping', 'imperative', 'imprisoning',
              'improving', 'including', 'increasing', 'ineffective', 'initiative', 'injecting', 'interesting',
              'involving', 'issuing', 'leading', 'limiting', 'living', 'maintaining', 'making', 'meaning', 'meeting',
              'mobilizing', 'morning', 'mounting', 'negative', 'negotiating', 'objective', 'opening', 'operating',
              'organizing', 'pointing', 'positive', 'preparing', 'presenting', 'prevailing', 'proceeding', 'promising',
              'proposing', 'prospective', 'providing', 'questioning', 'reaching', 'reconvening', 'regarding',
