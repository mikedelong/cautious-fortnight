# modified from https://github.com/lizadaly/brobot/
import logging
import os
import random
import sys
...
GREETING_RESPONSES = ['hey', 'hey you get my snap?', '*nods*', '\'sup bro', ]
...
def find_candidate_parts_of_speech(parsed):
    ...
    for sent in parsed.sentences:
        ...
        verb = find_verb(sent)
    logger.info('Pronoun={}, noun={}, adjective={}, verb={}'.format(pronoun, noun, adjective, verb))
